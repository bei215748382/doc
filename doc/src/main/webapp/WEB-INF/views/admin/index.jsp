...
<body>
			...
			<div id="sidebar-left" class="col-xs-2 col-sm-2">
				<ul class="nav main-menu">
					<li class="dropdown"><a href="#" class="dropdown-toggle">
							<i class="fa fa-table"></i> <span class="hidden-xs">医生信息管理</span>
					</a>
						<ul class="dropdown-menu">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle">
							<i class="fa fa-table"></i> <span class="hidden-xs">病人信息管理</span>
					</a>
						<ul class="dropdown-menu">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle">
							<i class="fa fa-table"></i> <span class="hidden-xs">医生好友管理</span>
					</a>
						<ul class="dropdown-menu">
							<li><a class="ajax-link" href="friends_info.do">信息预览</a></li>
						</ul></li>
					<li class="dropdown"><a href="#" class="dropdown-toggle">
							<i class="fa fa-table"></i> <span class="hidden-xs">容联云子账号管理</span>
					</a>
						<ul class="dropdown-menu">
							<li><a class="ajax-link" href="voip_info.do">账号明细</a></li>
						</ul></li>
					<li class="dropdown"><a href="#" class="dropdown-toggle">
							<i class="fa fa-table"></i> <span class="hidden-xs">字典管理</span>
					</a>
						<ul class="dropdown-menu">
							<li><a class="ajax-link" href="dictionary_info.do">内容明细</a></li>
						</ul></li>
					<li class="dropdown"><a href="#" class="dropdown-toggle">
							<i class="fa fa-table"></i> <span class="hidden-xs">预约管理</span>
					</a>
						<ul class="dropdown-menu">
							<li><a class="ajax-link" href="orders_info.do">预约列表</a></li>
						</ul></li>
					<li class="dropdown"><a href="#" class="dropdown-toggle">
							<i class="fa fa-table"></i> <span class="hidden-xs">问题反馈管理</span>
					</a>
						<ul class="dropdown-menu">
	...
	<script
		src="${ctx}/common/plugins/jquery-ui-timepicker-addon/jquery-ui-timepicker-addon.js"></script>
