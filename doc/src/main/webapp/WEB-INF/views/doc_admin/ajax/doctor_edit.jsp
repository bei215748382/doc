		...
		<div class="box">
			...
			<div class="box-content">
				...
				<form class="form-horizontal" role="form" method="POST"
					...
					<input type="hidden" name="subAccountSid" value="${doctor.subAccountSid}">
					<input type="hidden" name="subToken" value="${doctor.subToken}">
					<input type="hidden" name="friendName" value="${doctor.friendName}">
					<input type="hidden" name="dateCreated" value="${doctor.dateCreated}">
					<input type="hidden" name="voipAccount2" value="${doctor.voipAccount2}">
					<input type="hidden" name="voipPassword2" value="${doctor.voipPassword2}">
					<input type="hidden" name="subAccountSid2" value="${doctor.subAccountSid2}">
					<input type="hidden" name="subToken2" value="${doctor.subToken2}">
	...
	function loadProvince() {
		$.ajax({
			...
			success : function(data) {
				var htmlString = "<option value='${doctor.province}'>-- 选择省 --</option>";
