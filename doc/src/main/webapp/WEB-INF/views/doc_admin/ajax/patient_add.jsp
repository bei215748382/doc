	...
	<div class="col-xs-12 col-sm-12">
		<div class="box">
			<div class="box-header">
				<div class="box-name">
					<i class="fa fa-search"></i> <span>注册病人信息</span>
				</div>
				<div class="box-icons">
			...
			<div class="box-content">
				<h4 class="page-header">填写病人信息</h4>
				<form class="form-horizontal" role="form" method="POST"
					id="defaultForm" action="patient_add_json.do"
					...
					<input type="hidden" name="doctor_id" value="${activeDoc.id} ">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		LoadBootstrapValidatorScript(PatientFormValidator);
