...
function LoadCalendarScript(callback) {
	function LoadFullCalendarScript() {
		if (!$.fn.fullCalendar) {
			$.getScript('../common/plugins/fullcalendar/fullcalendar.js',
					callback);
		} else {
	...
	if (!$.fn.moment) {
		$.getScript('../common/plugins/moment/moment.min.js',
...
function LoadTimePickerScript(callback) {
	if (!$.fn.timepicker) {
		$
				.getScript(
						'../common/plugins/jquery-ui-timepicker-addon/jquery-ui-timepicker-addon.min.js',
						callback);
	} else {
		if (callback && typeof (callback) === "function") {
			callback();
...
function LoadBootstrapValidatorScript(callback) {
	if (!$.fn.bootstrapValidator) {
		$
				.getScript(
						'../common/plugins/bootstrapvalidator/bootstrapValidator.min.js',
						callback);
	} else {
		if (callback && typeof (callback) === "function") {
			callback();
...
function LoadDataTablesScripts(callback) {
	function LoadDatatables() {
		$
				.getScript(
						'../common/plugins/datatables/jquery.dataTables.js',
						function() {
							$
									.getScript(
											'../common/plugins/datatables/ZeroClipboard.js',
											function() {
												$
														.getScript(
																'../common/plugins/datatables/TableTools.js',
																function() {
																	$
																			.getScript(
																					'../common/plugins/datatables/dataTables.bootstrap.js',
																					callback);
																});
											});
						});
...
function LoadFineUploader(callback) {
	if (!$.fn.fineuploader) {
		$
				.getScript(
						'../common/plugins/fineuploader/jquery.fineuploader-5.0.1.min.js',
						callback);
	} else {
		if (callback && typeof (callback) === "function") {
			callback();
...
function LoadFlotScripts(callback) {
	function LoadFlotScript() {
		$.getScript('../common/plugins/flot/jquery.flot.js',
				LoadFlotResizeScript);
	}
	function LoadFlotResizeScript() {
		$.getScript('../common/plugins/flot/jquery.flot.resize.js',
				LoadFlotTimeScript);
	}
...
function LoadMorrisScripts(callback) {
	...
	if (!$.fn.raphael) {
		$.getScript('../common/plugins/raphael/raphael-min.js',
				LoadMorrisScript);
	} else {
		LoadMorrisScript();
	}
...
function LoadSparkLineScript(callback) {
	if (!$.fn.sparkline) {
		$.getScript('../common/plugins/sparkline/jquery.sparkline.min.js',
				callback);
	} else {
		if (callback && typeof (callback) === "function") {
			callback();
